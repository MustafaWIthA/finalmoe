...
value="{{old('first_name')}}" type="text" name="first_name" required="required" autofocus="autofocus" autocomplete="first_name">
...
<input  class="form-input rounded-md shadow-sm block mt-1 w-full" value="{{old('second_name')}}" type="text" name="second_name" required="required">
...
<input  class="form-input rounded-md shadow-sm block mt-1 w-full" value="{{old('username')}}"
...
<input  class="form-input rounded-md shadow-sm block mt-1 w-full" value="{{old('email')}}"
...
<input  class="form-input rounded-md shadow-sm block mt-1 w-full" value="{{old('birthdate')}}" type="date" name="birthdate" required="required">
