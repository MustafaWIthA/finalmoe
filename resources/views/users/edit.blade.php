...
<div class="flex items-center content-center">
        ...
        <form method="POST" action="{{ route('users.update',$user->id) }}">
            ...
            <div>
                ...
                <input class="form-input rounded-md shadow-sm block mt-1 w-full" type="text"
                    value="{{$user->first_name}}" name="first_name" required="required" autofocus="autofocus"
            ...
            <div class="mt-4">
                ...
                <input class="form-input rounded-md shadow-sm block mt-1 w-full" type="text" value="{{$user->username}}"
    ...
    <div class="w-full  mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg ml-3.5">
        <div>
            ...
            <input class="form-input rounded-md shadow-sm block mt-1 w-full" type="email" value="{{$user->email}}"
        ...
        <div class="mt-4">
            ...
            <input class="form-input rounded-md shadow-sm block mt-1 w-full" type="date" value="{{$user->birthdate}}"
...
<div>
    <div class="mt-6 px-6 py-6 bg-white shadow-md overflow-hidden sm:rounded-lg ml-3.5 content-center">
        <button type="submit"
            class="sm:w-full text-center inline-flex items-center px-4 py-4 
