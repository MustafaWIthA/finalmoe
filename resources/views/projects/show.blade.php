  ...
  <div class="flex-1 min-w-0">
    ...
    <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
      <div class="mt-2 flex items-center text-sm leading-5 text-gray-300 sm:mr-6">
        ...
        <span class="truncate px-4">Project Type:
      ...
      <div class="mt-2 flex items-center text-sm leading-5 text-gray-300 sm:mr-6">
        ...
        <span class="truncate px-4">Project Budget: 
      ...
      <div class="mt-2 flex items-center text-sm leading-5 text-gray-300">
        ...
        <span class="truncate px-4">Start Date: {{$project->start_date->format('D,M, Y')}}</span>
      </div>
      <div class="mt-2 flex items-center text-sm leading-5 text-gray-300">
        <svg class="flex-shrink-0 mr-1.5 h-10 w-7 text-gray-500" fill="white" viewBox="0 0 20 20">
          <path fill-rule="evenodd"
        ...
        <span class="truncate px-4">End Date: {{$project->end_date->format('D,M, Y')}}</span>
      </div>
    </div>
  </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-md">
      <ul>
        <li>  <a href="#" class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
          ...
          <li class="border-t border-gray-200">  <a href="#" class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
            <div class="flex items-center px-4 py-4 sm:px-6">
              <div class="min-w-0 flex-1 flex items-center">
                <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                  <div>
