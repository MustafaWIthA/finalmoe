...
@section('maintitle')
    ...
    <div class="lg:flex lg:items-center lg:justify-between bg-indigo-600 py-13 px-13 rounded-md">
        <div class="flex-1 min-w-0">
          ...
          <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
            ...
            <div class="mt-2 flex items-center text-sm leading-5 text-gray-300">
              ...
              Start Date: {{($project->start_date)->diffForHumans()}}
            </div>
            <div class="mt-2 flex items-center text-sm leading-5 text-gray-300">
                <svg class="flex-shrink-0 mr-1.5 h-10 w-7 text-gray-500" fill="bg-white" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd" />
                </svg>
                End Date: {{($project->end_date)->diffForHumans()}}
              </div>
          </div>
        </div>
