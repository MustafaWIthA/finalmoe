              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <textarea name="description" id="about" value="bc" placeholder="ss"
                ...
                <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                    ...
                    <input type="number" name="budget" value="{{$project->budget}}" id="Budget" class="pl-7 mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                  </div>
                </div>
                <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                  ...
                  <input type="number" value="{{$project->target}}" name="target" id="target" class="pl-7 mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                </div>
              </div>
                ...
                <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                  ...
                  <input type="date" type="start_date" name="start_date" id="start_date" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                </div>

                <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                    <label for="end_date" class="block text-sm font-medium leading-5 text-gray-700">End Date</label>
                    <input type="date" value="{{$project->end_date}}" name="end_date" id="end_date" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                </div>
              </div>
            </div>
          </div>
